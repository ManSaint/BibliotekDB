...
internal class DataAccess
{
    public void Seed()
    {
        using (Context context = new Context())
        {
            ...
            //author1.FirstName = "Mamma";
            //author1.LastName = "Muuuu";
            ...
            Book book2 = new Book();
            book1.Details = bookDetail2;
            book1.IsAvailable = true;

            Book book3 = new Book();
            book1.Details = bookDetail3;
            book1.IsAvailable = true;

            Book book4 = new Book();
            book1.Details = bookDetail4;
            book1.IsAvailable = true;

            Book book5 = new Book();
            book1.Details = bookDetail5;
            book1.IsAvailable = true;
            ...
            //if (!context.BookDetails.Any(bd => bd.ISBN == "2305601698198198191980"))
            //{
            //    context.BookDetails.Add(bookDetail1);
            //}
